...
public class LoanApplyController {
    ...
    public LoanApplyResult loanApply(LoanApplyRequest request, HttpServletRequest httpServletRequest) {

        return LoanPlatformTemplate.run(new LoanApplyProcessor(), request, new LoanApplyResult(),
            httpServletRequest, borrowerRepository, borrowerOrderRepository);
